...
set subject="e:\zby\document\gene.sequence\pUAST_8904.fa"
set outFile=result.htm

forfiles /m *.seq /c "cmd /c blastn -task blastn-short -query @file -subject %subject% -outfmt 0 > @fname.blastout"
