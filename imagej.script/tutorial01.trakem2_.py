...
# 2. On line 6, Project.getProjects().get(0), what's the meaning of "."?
#    (It's about Java classes' methods, you can search the web, preferably Google.)
# 3. Comment out line 10, or line 11, or line 12, what happened?
#    (You can search what is a comment and how to use it in Python.)
# 4. On line 13, what is the meaning of "."? What will happen if you delete the "[]"?
#    (It's about Python class methods, again search for it.)
#    (After you omit the [], check the output test.csv file.)
# 5. On line 8, what will happen if you change the 2nd "neurite" (the one in double quotes)
#    to "synapse" (don't omit the double quotes)? What will happen if you change the first occurence?
# 6. On line 12, what will happen if you change neurite.getTitle() to neurite.getId() ?
#